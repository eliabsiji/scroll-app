var customerList, checkAll = document.getElementById("checkAll"), perPage = (checkAll && checkAll.addEventListener("click", function() {
    var e = document.querySelectorAll('.form-check-all input[type="checkbox"]');
    Array.from(e).forEach(function(e) {
        e.checked = checkAll.checked,
        e.checked ? e.closest("tr").classList.add("table-active") : e.closest("tr").classList.remove("table-active")
    })
}),
...
var table = document.getElementById("customerTable")
  ...
  , statusVal = (Array.prototype.slice.call(forms).forEach(function(a) {
    a.addEventListener("submit", function(e) {
        ...
        "" === customerNameField.value || "" === emailField.value || "" === dateField.value || "" === phoneField.value || editlist ? "" !== customerNameField.value && "" !== emailField.value && "" !== dateField.value && "" !== phoneField.value && editlist && (t = customerList.get({
            id: idField.value
        }),
...
function deleteMultiple() {
    ...
    if (Array.from(e).forEach(function(e) {
        1 == e.checked && (e = e.parentNode.parentNode.parentNode.querySelector(".id a").innerHTML,
        ids_array.push(e))
    }),
