...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_64869861d1304">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_64869861d1304" data-allow-clear="true">
                    <option></option>
...
<!--end::User Info-->        <!--end::Summary-->
        ...
        <div id="kt_user_view_details" class="collapse show">
            <div class="pb-5 fs-6">
                    ...
                    <div class="text-gray-600">25 Jul 2023, 10:30 am</div>
                    <!--begin::Details item-->
                            </div>
        </div>
        <!--end::Details content-->
        ...
        <div class="table-responsive">
            ...
            <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
                <tbody>
                            ...
                            <td>
                               POST /v1/invoice/in_8292_7879/invalid                            </td>
                            ...
                            <td>
                               POST /v1/invoices/in_1709_3452/payment                            </td>
                            <td class="pe-0 text-end min-w-200px">
                            ...
                            <td>
                               POST /v1/customer/c_64869861d1569/not_found                            </td>
                            <td class="pe-0 text-end min-w-200px">
                            ...
                            <td>
                               POST /v1/invoices/in_6595_3338/payment                            </td>
                            <td class="pe-0 text-end min-w-200px">
