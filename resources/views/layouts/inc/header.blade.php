        ...
        <div class="card-body py-5">
            ...
            <div class="mh-450px scroll-y me-n5 pe-5">
                ...
                <div class="row g-2">
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ asset('html/assets/assets/media/svg/brand-logos/beats-electronics.svg')}}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ asset('html/assets/assets/media/svg/brand-logos/codeigniter.svg')}}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ asset('html/assets/assets/media/svg/brand-logos/bootstrap-4.svg')}}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ asset('html/assets/assets/media/svg/brand-logos/google-tag-manager.svg')}}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ asset('html/assets/assets/media/svg/brand-logos/disqus.svg')}}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ asset('html/assets/assets/media/svg/brand-logos/dribbble-icon-1.svg')}}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ asset('html/assets/assets/media/svg/brand-logos/google-play-store.svg')}}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ asset('html/assets/assets/media/svg/brand-logos/google-podcasts.svg')}}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ asset('html/assets/assets/media/svg/brand-logos/figma-1.svg')}}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ asset('html/assets/assets/media/svg/brand-logos/github.svg')}}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ asset('html/assets/assets/media/svg/brand-logos/gitlab.svg')}}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ asset('html/assets/assets/media/svg/brand-logos/instagram-2-1.svg')}}" class="w-25px h-25px mb-2" alt=""/>
                        ...
                        <div class="col-4">
                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                <img src="{{ asset('html/assets/assets/media/svg/brand-logos/pinterest-p.svg')}}" class="w-25px h-25px mb-2" alt=""/>
...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-5">
        <a href="{{ asset('html/assets/apps/projects/list.html')}}" class="menu-link px-5">
    ...
    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
        ...
        <div class="menu-sub menu-sub-dropdown w-175px py-4">
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <a href="{{ asset('html/assets/account/referrals.html')}}" class="menu-link px-5">
                    Referrals
                </a>
            </div>
            <!--end::Menu item-->
            ...
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <a href="{{ asset('html/assets/account/billing.html')}}" class="menu-link px-5">
                    Billing
                </a>
            </div>
            <!--end::Menu item-->
            ...
            <!--begin::Menu item-->            
            <div class="menu-item px-3">
                <a href="{{ asset('html/assets/account/statements.html')}}" class="menu-link px-5">
                    Payments
                </a>
            </div>
            <!--end::Menu item-->
            ...
            <!--begin::Menu item-->            
            <div class="menu-item px-3">
                <a href="{{ asset('html/assets/account/statements.html')}}" class="menu-link d-flex flex-stack px-5">
                    Statements
    ...
    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
        <a href="#" class="menu-link px-5">
            <span class="menu-title position-relative">
                ...
                <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                    English <img class="w-15px h-15px rounded-1 ms-2" src="{{ asset('html/assets/assets/media/flags/united-states.svg')}}" alt=""/>
                </span>
            </span>
        </a>
        ...
        <div class="menu-sub menu-sub-dropdown w-175px py-4">
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <a href="{{ asset('html/assets/account/settings.html')}}" class="menu-link d-flex px-5 active">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ asset('html/assets/assets/media/flags/united-states.svg')}}" alt=""/>
                    </span>
                    English
                </a>
            </div>
            ...
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <a href="{{ asset('html/assets/account/settings.html')}}" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ asset('html/assets/assets/media/flags/spain.svg')}}" alt=""/>
                    </span>
                    Spanish
                </a>
            </div>
            ...
            <div class="menu-item px-3">
                <a href="{{ asset('html/assets/account/settings.html')}}" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ asset('html/assets/assets/media/flags/germany.svg')}}" alt=""/>
                    </span>
                    German
                </a>
            </div>
            ...
            <div class="menu-item px-3">
                <a href="{{ asset('html/assets/account/settings.html')}}" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ asset('html/assets/assets/media/flags/japan.svg')}}" alt=""/>
                    </span>
                    Japanese
                </a>
            </div>
            ...
            <div class="menu-item px-3">
                <a href="{{ asset('html/assets/account/settings.html')}}" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ asset('html/assets/assets/media/flags/france.svg')}}" alt=""/>
                    </span>
                    French
                </a>
            </div>
    ...
    <div class="menu-item px-5 my-1">
        <a href="{{ asset('html/assets/account/settings.html')}}" class="menu-link px-5">
            Account Settings
        </a>
    </div>
    <!--end::Menu item-->
